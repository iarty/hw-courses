						...
						<MDBContainer>
							<MDBRow>
								<MDBCol md='12' className='mb-4 white-text text-center'>
									<h1 class='display-3 mb-0 pt-md-5 pt-5 white-text font-weight-bold'>
										JOHN <span className='indigo-text font-weight-bold'>DOE</span>
									</h1>
									...
									<NavLink to="/portfolio">
										<MDBBtn className='white btn-light-blue' size='lg' to=''>
											portfolio
										</MDBBtn>
									</NavLink>
									<NavLink to="/contacts">
